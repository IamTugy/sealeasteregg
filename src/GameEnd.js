...
class GameEnd extends Phaser.Scene {
  ...
  create() {
    ...
    this.highScoreText = this.add.text(screenCenterX, 350, 'High Score: ' + this.highscore, { fill: '#535353', font: '900 35px Courier' }).setOrigin(0.5);
    this.scoreText = this.add.text(screenCenterX, 400, 'Score: ' + this.score, { fill: '#535353', font: '900 35px Courier' }).setOrigin(0.5);
